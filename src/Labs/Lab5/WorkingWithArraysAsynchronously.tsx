...
export default function WorkingWithArraysAsynchronously() {
    ...
    // Sends out PUT request and updates local list
    ...
    const postTodo = async () => {
        const tempNewTodo = { title: "Clicked new button", completed: false, };
        const newTodo = await client.postTodo(tempNewTodo);
