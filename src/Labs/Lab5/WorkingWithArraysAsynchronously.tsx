...
export default function WorkingWithArraysAsynchronously() {
    ...
    const updateTodoCompleted = async (todo: any, completed: boolean) => {
        const updatedTodos = await client.updateCompleted(todo, completed);
                ...
                {todos.map((todo) => (
                    <ListGroup.Item key={todo.id}>
                        ...
                        <input type="checkbox" className="form-check-input me-2" defaultChecked={todo.completed}
                            onChange={() => updateTodoCompleted(todo, !todo.completed)} />
